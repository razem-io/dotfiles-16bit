...
theme.wallpaper = "~/.wallpapers/deamon1.jpg"
theme.wallpaper_cmd = { "awsetbg "..theme.default_themes_path.."/zenburn/zenburn-background.png" }
theme.colors = {}
theme.colors.base3   = "#1d1f21ff"
theme.colors.base2   = "#282a2eff"
theme.colors.base1   = "#373b41ff"
theme.colors.base0   = "#969896ff"
theme.colors.base00  = "#b4b7b4ff"
theme.colors.base01  = "#c5c8c6ff"
theme.colors.base02  = "#e0e0e0ff"
theme.colors.base03  = "#ffffffff"
theme.colors.yellow  = "#cc6666ff"
theme.colors.orange  = "#de935fff"
theme.colors.red     = "#f0c674ff"
theme.colors.magenta = "#b5bd68ff"
theme.colors.violet  = "#8abeb7ff"
theme.colors.blue    = "#81a2beff"
theme.colors.cyan    = "#b294bbff"
