...
-- Vicious dynamic widget library
...
run_once  ("compton")
run_always("setxkbmap de")
run_always("xrdb merge ~/.Xresources")
run_once  ("nm-applet")
run_once  ("dunst -config .config/dunst/dunst.conf")
...
beautiful.init("~/.config/awesome/themes/16bit/theme.lua")

-- This is used later as the default terminal and editor to run.
terminal = "urxvt -e fish"
editor = os.getenv("EDITOR") or "nano"
editor_cmd = terminal .. " -e " .. editor
dmenu = "rofi -show run -sidebar-mode"
...
-- {{{ Tags
 ...
 tags = {
   names  = { " 1: TERM", " 2: IDE", " 3: WEB", " 4: IM", " 5: MEDIA", " 6: GAMES"}
...
vicious.register(bitcoinwidget, worker, '  %s€ ', 30)
...
for s = 1, screen.count() do
    ...
    right_layout:add(bitcoinwidget)
...
awful.rules.rules = {
    ...
    { rule = { class = "jetbrains-idea-ce" },  properties = {tag = tags[1][2]}},
    { rule = { class = "Atom" },  properties = {tag = tags[1][2]}}
}
-- }}}
